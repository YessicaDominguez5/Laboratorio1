...
int main () {
float sindes, condes, porc;
cout << "Ingrese el valor del articulo sin descuentos aplicados: ";
cin >> sindes;
cout << endl;
cout << "Ingrese el valor del articulo con el descuento: ";
cin >> condes;
cout <<endl;
porc = (((sindes - condes)*100)/sindes);
cout << "El porcentaje de descuento es de " << porc << "%"<< endl;
